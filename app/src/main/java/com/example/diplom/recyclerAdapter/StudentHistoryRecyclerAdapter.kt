...
import com.example.diplom.StudentHistoryInfoActivity
import com.example.diplom.StudentReportHistoryActivity
import com.example.diplom.TeacherCabinetInfoActivity
import com.example.diplom.models.ModelClassStudentHistory

class StudentHistoryRecyclerAdapter (private val history: List<ModelClassStudentHistory>?, private val activity: StudentReportHistoryActivity) : RecyclerView.Adapter<StudentHistoryRecyclerAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.historyDate?.setOnClickListener {
            val intent : Intent = Intent(holder.itemView.context, StudentHistoryInfoActivity::class.java)
            intent.putExtra("idRep", history[position].id)
